...
namespace VJoyPad
{
    class VJoy
    {
        ...
        {
            m_joyState[ID].ReportId = 0;
            m_joyState[ID].XAxis = 0;
            m_joyState[ID].YAxis = 0;
            m_joyState[ID].ZAxis = 0;
            m_joyState[ID].XRotation = 0;
            m_joyState[ID].YRotation = 0;
            m_joyState[ID].ZRotation = 0;
            m_joyState[ID].Slider = 0;
            m_joyState[ID].Dial = 0;
            m_joyState[ID].POV = ((int)POVType.Nil << 12) | ((int)POVType.Nil << 8) | ((int)POVType.Nil << 4) | (int)POVType.Nil;
            m_joyState[ID].Buttons = 0;
        }
